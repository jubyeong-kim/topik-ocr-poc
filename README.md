...
#### 🔑 가장 중요한 발견 — CLOVA 는 글자를 읽고, 띄어쓰기를 놓친다
...
1. **완전 자동 채점은 아직 불가.** 최고 성능(CLOVA)에서도 일치율 32% 로, 정답 문자열 비교 방식의
   51/52번 자동채점에는 못 쓴다. CER 목표는 달성했지만 일치율 목표(80%)는 여전히 크게 미달이다.
